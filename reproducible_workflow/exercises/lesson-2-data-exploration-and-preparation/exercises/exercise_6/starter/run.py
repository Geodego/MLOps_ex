...
def go(args):
    ...
    # we handle MLflow limitations concerning optional arguments handling with if args.stratify != "null" else None
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='null'  # unfortunately mlflow does not support well optional parameters we cannot use None
    )
